...
function seeMore(artist) {
  ...
  fetch(wikiUrl)
    ...
    .catch(function (error) {
      ...
      // Hide all elements inside the #second-page-btn div except the home button
      const secondPageButtons = document.querySelector("#second-page-btn");
      secondPageButtons
        .querySelectorAll("button:not(.home-button)")
